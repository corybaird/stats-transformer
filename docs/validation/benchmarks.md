...
| **Applied Regression** | `src.examples.regression.ghysels_chap1` | Ghysels & Marcellino (2018) Chapter 1 | `data/examples/academic/ghysels_2018/Ch_1/ex2_regress_gdp.csv` | **Textbook Replication Example** | Linear trend & seasonal dummy regression models |
| **Applied Regression** | `src.examples.regression.ghysels_chap2` | Ghysels & Marcellino (2018) Chapter 2 | `data/examples/academic/ghysels_2018/Ch_2/ex1_regress_gdp.csv` | **Textbook Replication Example** | Autoregressive distributed lag (ARDL) forecasting |
